            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="app-brand justify-content-center">
                        <img src="../assets/img/favicon/imedical_log.png" style="height: 150px; " >
                    </div>
                    <!-- /Logo -->
                    <h4 class="mb-2"> A forma ágil e segura de atender</h4>
                    <p class="mb-4">Torne sua rotina mais fácil, rápida e segura!</p>
