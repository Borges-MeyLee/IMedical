                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    if(isset($_GET['erro'])){
                        ...
                        <div class="alert alert-danger" role="alert">
                            <?= $msg = "Procedimento não pode ser cadastrado."?>
                        </div>
                        <?php
                    }
                    ?>
                    ...
                    <div class="col-xl">
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <form action="functions/new_procedures.php" method="post">
                                    <div class="mb-3 row">
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select"
                                                id="escolher-paciente"
                                                name="escolher-paciente">
                                            <option selected>Selecione o nome do paciente para o novo
                                            procedimento</option>
                                            <?php
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select"
                                            ...
                                            while ($procedimento = $resultado->fetch_assoc()){
                                                ?>
                                                <option value="<?= $procedimento['id_tipo_procedimento']?>"><?= $procedimento['descricao']?></option>
                                                <?php
                                            }
                                            ?>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea
                                                ...
                                                class="form-control"
                                                required="required"
                                                placeholder="Escreva o nome do medicamento e/ou cuidado de enfermagem"></textarea>
